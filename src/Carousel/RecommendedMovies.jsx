// src/components/NetflixTrending.js
...
import { SiPrimevideo, SiAppletv, SiNetflix } from "react-icons/si";
...
const NetflixTrending = () => {
  ...
  return (
    ...
    <h1 className='mx-24 text-white flex text-3xl font-bold items-center mb-4'> Top 5 <SiNetflix  className='ml-5 text-4xl text-[#E50914]'/>
     </h1>
