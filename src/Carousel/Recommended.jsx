// src/components/AmazonPrimeTrending.js
...
const AmazonPrimeTrending = () => {
  ...
  const settings = {
    ...
    slidesToScroll: 1,
    arrows: true,
    prevArrow: <button className="slick-prev text-black">Previous</button>,
    nextArrow: <button className="slick-next text-black">Next</button>,
    customPaging: (i) => (
    ...
    appendDots: (dots) => (
      ...
      >
        <ul className="list-none m-0">{dots}</ul>
      </div>
    ),
  };
  ...
  return (
    <div className="relative flex flex-col justify-end">
        <h1 className='mx-24 text-white flex text-3xl font-bold items-center mb-4'> Top 5 < SiPrimevideo  className='ml-5 text-[#1399FF] text-7xl'/> </h1>
...
export default AmazonPrimeTrending;
