// src/components/DisneyPlusTrending.js
...
const DisneyPlusTrending = () => {
  ...
  return (
    ...
    <h1 className='mx-24 text-white flex text-3xl font-bold items-center mb-4'> Top 5 <TbBrandDisney className='ml-5 text-[#006B99] text-6xl'/> </h1>
      ...
      <div key={movie.id} className="mb-2  mx-20 ">
       ...
       <div>
         <img
          ...
          <h4 className="text-sm text-white font-medium mt-2 ">{movie.title}</h4>
          </div>
